                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start space-y-3 sm:space-y-0">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
                            <h3 className="text-base sm:text-lg font-bold text-gray-900">#{order.id.slice(0, 8)}</h3>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-xs sm:text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600 truncate">Address: <span className="font-medium text-gray-900">{order.delivery_address}</span></p>
                            </div>
                          </div>
                        </div>
                      ...
                      {order.status !== 'delivered' && order.status !== 'cancelled' && (
                        <div className="flex space-x-2 mt-4">
                          <select
                            className="px-2 sm:px-3 py-2 border border-gray-300 rounded-md text-xs sm:text-sm w-full sm:w-auto"
                            value={order.status}
